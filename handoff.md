...
## 当前版本目标
- 当前已从 V2.1-N3：移动端重复选项与种草按钮修正，进入 V2.1-N4：重复滚动修复、segmented 高度对齐、favicon。
- 本轮核心目标是修正移动端重复选项滚动总长度问题、对齐顶部 segmented 高度，并接入网页图标。

## 最近一次完成的 task
- 完成 V2.1-N4 小修正：
  - 移动端重复选项的横向滚动长度已真正展开
  - 顶部两组 segmented control 已只做高度对齐
  - `logo.PNG` 已接为网页 favicon
